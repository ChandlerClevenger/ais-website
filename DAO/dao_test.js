...
// set stub to true within each unit test function. unit tests should test two features: can be called without connection to database, and if it catches bad input
